...
<head>
    <title>PHP-Exercise-Three</title>
    <meta charset="UTF-8">
    ...
    <header>
        <nav class="navigation">
            ...
            <ul id="navi-list">
                ...
                <li><a href="http://127.0.0.1/web-php-aufgabe-1/uebung/uebung3.php" class="active-page">Nr3</a></li>
    ...
    <main>
        ...
        <section>
            <form action="uebung3.php" method="post">
                <div class="benzin">
                    <p>Benzin:</p>
                    <input name="benzin"></input>
                    <p>l</p>
                </div>
                <div class="super">
                    <p>Super:</p>
                    <input name="super"></input>
                    <p>l</p>
                </div>
        ...
        <?php
        if (isset($_POST["benzin"]) || isset($_POST["super"])) {
            $cost = 0;
            if (is_numeric($_POST["benzin"])) {
                $cost += $_POST["benzin"] * 1.35;
            }
            if (is_numeric($_POST["super"])) {
                $cost += $_POST["super"] * 1.40;
            }
            echo "<p>Tank Cost: " . number_format($cost, 2) . "&#8364</p>";
        }
        ?>
